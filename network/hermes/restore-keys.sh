...
sleep 1s
### Restore Keys
$HERMES_BINARY -c ./network/hermes/config.toml keys restore interamm -m "alley afraid soup fall idea toss can goose become valve initial strong forward bright dish figure check leopard decide warfare hub unusual join cart"
sleep 5s
